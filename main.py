    ...
    while len(filelist) != 0:
        ...
        for file in filelist:
            target_url = "{}/api.php?api_key={}&action=getfile&&hash={}".format(malshare,
                                                                                ...
                                                                                file)
            try:
                download.download(target_url, "{}/{}".format(today_dir, file),
...
def main():
    ...
    parser.add_argument('-t', "--timeout", required=False, default=300, type=int,
                        help="Longest time for downloading files.")
